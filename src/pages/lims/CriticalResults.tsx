...
const data = [
  { p: "Thandiwe Mokoena", ln: "TPL-2026-04-30-0142", test: "Potassium (K+)", val: "7.2 mmol/L", range: "3.5–5.1", dr: "Dr. M. Phakathi", phone: "+27 82 555 0142", contact: "Pending", release: "Held" },
  { p: "Sibusiso Khumalo", ln: "TPL-2026-04-30-0143", test: "Hemoglobin",     val: "4.1 g/dL",   range: "13.5–17.5", dr: "Dr. R. Yemmy",   phone: "+27 82 555 0188", contact: "Doctor Notified · 09:11", release: "Released" },
  { p: "Naledi Dlamini",   ln: "TPL-2026-04-30-0144", test: "INR",            val: "8.4",        range: "0.8–1.2",   dr: "Dr. F. Ike",     phone: "+27 82 555 0207", contact: "Pending · OVERDUE", release: "Held" },
];
  ...
  return (
    <>
      <PageHeader
        ...
        actions={<Pill tone="danger" pulse>3 active</Pill>}
      />
      <Panel>
        <div className="overflow-x-auto rounded-lg border border-border">
          <table className="data-table">
            <thead>
              <tr>
                <th>Patient</th><th>Lab Number</th><th>Test</th><th>Critical Value</th>
              ...
              {data.map((r) => (
                <tr key={r.ln}>
                  ...
                  <td className="flex gap-1">
                    <button className="text-[10px] font-semibold bg-blue-600 text-white px-2 py-1 rounded inline-flex items-center gap-1"><Phone className="h-3 w-3" />Mark Contacted</button>
                    {r.contact.includes("OVERDUE") && <button className="text-[10px] font-semibold bg-red-600 text-white px-2 py-1 rounded inline-flex items-center gap-1"><ShieldAlert className="h-3 w-3" />Escalate</button>}
                  </td>
                </tr>
              ))}
            </tbody>
