  ...
  return (
    <>
      <PageHeader
        ...
        actions={<button onClick={() => form.open({ title: "Create Laboratory", fields: NEW_LAB_FIELDS, size: "lg" })} className="bg-target text-white text-xs font-semibold px-3 py-2 rounded-lg inline-flex items-center gap-1.5"><Plus className="h-3.5 w-3.5" />Create Laboratory</button>}
      />
      <Panel>
